...
- [Обзор некоторых функций "string.h"](#обзор-библиотеки-stringh)
    ...
    - [sprintf Ширина](#sprintf-ширина)
    - [sprintf Точность](#sprintf-точность)
    - [sprintf Длина](#sprintf-длина)
...
- Unit-тесты покрывают не менее 90% каждой функции
